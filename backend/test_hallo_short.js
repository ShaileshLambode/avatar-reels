...
async function runTest() {
  console.log("==================================================");
  console.log("   Hallo3 Local Integration Short Test (3s)       ");
  console.log("==================================================");
  
  const assets = {
    audioPath: "storage/temp/sample/audio_short.wav" // 3s voice sample
  };
  
  const avatarConfig = {
    avatarImage: null, // Forces fallback to assets/avatars/default.png
    relative_motion_mode: true,
    engine: "hallo" // Force Hallo3 engine
  };
  
  const reelId = "test_hallo_short";
